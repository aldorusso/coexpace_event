            ...
            <div className="row align-items-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="td-hero-content p-relative mb-30 pl-165">
                     ...
                     <div className="td-hero-buttons d-flex gap-3 mb-30 flex-wrap">
                        ...
                        <Link className="td-btn td-btn-support td-left-right wow td-animetion-top" data-wow-duration="1.5s" data-wow-delay="1.1s" href="https://www.google.es" target="_blank">
